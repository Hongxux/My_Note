...
#### 1. 缓冲池 - Buffer Pool：[[MySQL主内存缓存区]]

    

#### 2. [[MySQL更改缓冲区]] - Change Buffer：非唯一索引的写优化器


    

#### 3. [[MySQL自适应哈希索引]] - Adaptive Hash Index：查询加速器


    

#### 4. [[MySQL日志缓冲区]] - Log Buffer：日志的中间站
...
## [[InnoDB日志机制]]（ redo log + undo log + binlog）
