...
**数据分片的基础：哈希槽**
- 需求背景：
	- 简单哈希取余：扩展性极差，节点数变则映射全变
	- 

- 解决措施：哈希槽（[Hash](app://obsidian.md/Hash.md)🔗 Slot）
	- 本质上是在Key和节点之间增加了一层固定映射表。![[Redis 分片集群 2025-11-24 18.18.59.excalidraw]]
- 工作模式：集群中总共有16384个哈希槽（0 ~ 16383）。
